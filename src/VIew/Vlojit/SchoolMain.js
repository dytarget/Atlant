...
export class SchoolMain extends Component {
    constructor(){
        super();
        this.state={
            isLoading:true,
            ...
            <div>
                ...
                <MDBContainer>
                    <MDBCarousel
                        ...
                        className="z-depth-1"
                        style={{position:"absolute",top:0,zIndex:0,maxWidth:"100%",height:"70vh",left:0}}
                    >
                        <MDBCarouselInner>
                        <MDBCarouselItem className="car-item" itemId="1">
                            ...
                            <img
                                ...
                                src={require('../../img/laptop-computer-1245981_1920.jpg')}
                                alt="First slide"
                            />
                            <MDBMask overlay="black-strong"  />
                            </MDBView>
                            <MDBCarouselCaption className="texts-car analitic-car">
                                <span className="titlecarousel">Школа Atlant</span>
